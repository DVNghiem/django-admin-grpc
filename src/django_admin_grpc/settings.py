...
DEFAULTS: dict[str, Any] = {
    ...
    "GRPC_ADMIN_CACHE_ENABLED": False,
    "GRPC_ADMIN_CACHE_TTL": 60,
    "GRPC_ADMIN_CACHE_PREFIX": "grpc_admin",
    "GRPC_ADMIN_CACHE_BACKEND": "default",
    "GRPC_ADMIN_AUDIT_BACKEND": None,
    "GRPC_ADMIN_CONTEXT_PROVIDERS": [],
    "GRPC_ADMIN_TENANT_HEADER": "x-tenant-id",
